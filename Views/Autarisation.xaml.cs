...
//                        var chatWindow = new ChatWin(_serverClient,result.Id,result.Name);
//                        chatWindow.Show();
//                        this.Close();
//                    }
//                    else
...
//    public partial class Autarisation : Window
//    {
//        private TcpClientService _serverClient;
...
//            try
//            {
//                _serverClient = new TcpClientService();
//                lblStatus.Text = "Подключение к серверу...";
//                lblStatus.Foreground = new SolidColorBrush(Colors.Blue);

//                bool connected = _serverClient.Connect(_serverIp, _port);
...
//                string credentials = $"{txtLogin.Text.Trim()}:{txtPassword.Password}";
//                await _serverClient.SendMessageAsync(credentials);

//                string response = await _serverClient.ReceiveMessageAsync();

//                if (response == "OK" || response.StartsWith("SUCCESS"))
//                {
//                    lblStatus.Text = $"Добро пожаловать, {txtLogin.Text}!";
//                    lblStatus.Foreground = new SolidColorBrush(Colors.Green);

//                    MessageBox.Show($"Добро пожаловать в чат, {txtLogin.Text}!",
//                        "Успешный вход", MessageBoxButton.OK, MessageBoxImage.Information);

//                    var chatWindow = new MainWindow(_serverClient, txtLogin.Text.Trim());
//                    chatWindow.Show();
//                    this.Close();
//                }
//                else
//                {
//                    ShowError(response == "ERROR" ? "Неверный логин или пароль" : response);
...
//                    // ЕДИНСТВЕННОЕ ИЗМЕНЕНИЕ - открываем MainWindow вместо ChatWin
//                    var chatWindow = new MainWindow(_serverClient, txtLogin.Text.Trim());
//                    chatWindow.Show();
//                    this.Close();
//                }
